...
def main():
    ...
    train_dataset = hf_loaders.get_babyLM(name="babyLM-10M", split="train")
    # dev_dataset = hf_loaders.get_babyLM(name="babyLM-10M", split="dev")
    ...
    def group_texts(examples):
        ...
        # Then concatenate them all together as input ids and labels.
        # TODO: (maybe) for each source pack examples following https://openreview.net/pdf?id=ms7xJWbf8Ku
